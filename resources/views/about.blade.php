...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container">
    ...
    <div class="titlecol"> ABOUT ME </div>
...
<a href="#" class="photo">
  <div class="about">Aero <br>Canlas</div>
    <img src="img/ae pic.jpg" />
  <div class="glow-wrap">
    <i class="glow"></i>
  </div>
</a>
...
<div class="aboutDesc"> I am passionate about cars and I enjoy collecting Hot Wheels. </div>

<div class ="hw">

<img src="img/hw.png"></div>
    <!-- Showcase -->
