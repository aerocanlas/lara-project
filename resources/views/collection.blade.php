...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container">
    ...
    <div class="titlecol"> COLLECTION </div>
    ...
    <div class="section-fluid-main">
		<div class="section-row">
			...
			<div class="hover-text">
				<h2>'17 Nissan GT-R <br> (R35)</h2>
			</div>
			<div class="section-col">
				<div class="section">
					<div class="section-in h10">
						<img src="img/240z.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
				<h2>Custom Datsun <br>240Z</h2>
			</div>
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="img/r30.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
				<h2>'82 Nissan Skyline <br>R30</h2>
			</div>
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="img/507.jpg" alt="">
					</div>
				</div>
			</div>
      <div class="hover-text">
